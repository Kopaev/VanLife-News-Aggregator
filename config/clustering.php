...
return [
    ...
    // Алгоритмические настройки кластеризации
    'algorithm' => [
        // Сколько статей без кластера обрабатывать за один запуск
        'batch_size' => (int)env('CLUSTER_BATCH_SIZE', 20),

        // Сколько кандидатов рассматривать на схожесть для каждой статьи
        'candidates_limit' => (int)env('CLUSTER_CANDIDATES_LIMIT', 80),
