...
- [x] NewsProcessor для AI-оценки релевантности и маршрутизации статей на публикацию/модерацию/отклонение
...
### NewsProcessor (ИИ-оценка релевантности)
Сервис `App\Service\NewsProcessor` использует OpenAI для определения релевантности новостей vanlife-аудитории. На основе ответа модели выбирается статус статьи:
